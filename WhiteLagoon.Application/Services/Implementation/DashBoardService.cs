...
public class DashboardService(IUnitOfWork unitOfWork) : IDashboardService
{
    ...
    {
        var bookingData = unitOfWork.BookingRepository.GetAll(u => u.BookingDate >= DateTime.Now.AddDays(-30) &&
        ...
        var customerData = unitOfWork.ApplicationUserRepository.GetAll(u => u.CreatedAt >= DateTime.Now.AddDays(-30) &&
